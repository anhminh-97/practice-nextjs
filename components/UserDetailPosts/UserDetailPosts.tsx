        ...
        <div className="ass1-section">
          ...
          <div className="ass1-section__content">
            <p>
              ...
              deserunt ut, aperiam quas! Placeat blanditiis consequatur, deserunt facere iusto amet
              a ad suscipit laudantium unde quidem perferendis!
            </p>
      ...
      <div className="ass1-section__item col-lg-6">
        <div className="ass1-section">
          ...
          <div className="ass1-section__content">
            ...
            <div className="ass1-section__image">
              <a href="single_post.html">
                <Image src="/images/blog-rating.png" alt="" width={670} height={450} />
              </a>
            </div>
          </div>
          <div className="ass1-section__footer">
      ...
      <div className="ass1-section__item col-lg-6">
        <div className="ass1-section">
          ...
          <div className="ass1-section__content">
            ...
            <div className="ass1-section__image">
              <a href="single_post.html">
                <Image src="/images/dress_owesom.jpg" alt="" width={670} height={450} />
              </a>
            </div>
          </div>
          <div className="ass1-section__footer">
      ...
      <div className="ass1-section__item col-lg-6">
        <div className="ass1-section">
          ...
          <div className="ass1-section__content">
            ...
            <div className="ass1-section__image">
              <a href="single_post.html">
                <Image src="/images/frog-1530803_960_720.jpg" alt="" width={670} height={450} />
              </a>
            </div>
          </div>
          <div className="ass1-section__footer">
